...
function TodoItem({todo}) {
    ...
    const {updateTodo, deleteTodo, toggleComplete} = useUnifiedTodo();
  ...
  return (
    <>
            <div className={`flex border border-black/10 rounded-lg px-3 py-1.5 my-2 gap-x-3 shadow-sm shadow-white/50 duration-300  text-black ${
